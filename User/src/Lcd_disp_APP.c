...
//	modefy		:null
//===============================================================================
void Clear_apage(uint8_t Page_addrs)			//清除1页
{
    uint8_t i;
...
//	modefy		:null
//===============================================================================
void Clear_n_page(uint8_t start,uint8_t Page_addrs)			//清除1页和对应页的显示区
{
    uint8_t i,j;
...
//	modefy		:null
//===============================================================================
void Clear_n_page_ram(uint8_t start,uint8_t Page_addrs)			//清除多页显示区
{
   uint8_t i,j;
...
//    DrvGPIO_SetBit_new (E_GPA,14);			//CONT set HIGHT
    ...
    Tx_cmd_to_lcm(0x23);			//粗调对比度
    Tx_cmd_to_lcm(CMD_INTER_LCD_VOL_SET);
    Tx_cmd_to_lcm(0x36);			//微调对比度
    M_menur1_lcd_Contrast_temp=0x36;
                                        	
    Tx_cmd_to_lcm(CMD_SET_BIAS_VOL9);		//bias vol is lever 9   	
    Tx_cmd_to_lcm(CMD_REV_LINE_SCAN);		//lcd scan from up to down
 //   Tx_cmd_to_lcm(CMD_NOR_LINE_SCAN);	
    Tx_cmd_to_lcm(CMD_DIS_ADDS_L2R);		//lcd scan from L to R
    Tx_cmd_to_lcm(CMD_MORMAL_DISP);
    Tx_cmd_to_lcm(CMD_DIS_START_LINE);		//frist line start
    Tx_cmd_to_lcm(CMD_LCM_ON);
...
//=============================================================================== 
//	finction	:rev_clear_set_arear16	:LCM use 8080 system	//反显区域
//	input		:null
//	output		:null
//	return		:null
//	edit		:sam 2013-4-8 17:20
...
//	modefy		:null
//===============================================================================
uint8_t Get_ascii_data(uint8_t data)		//ASCII码转换
{
     uint8_t i;
