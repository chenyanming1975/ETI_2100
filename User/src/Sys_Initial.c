...
//===============================================================================
//	finction	 :System_clk_initial
//	edit		   :sam 2012.06.06
//	description：系统时钟设置初始化
//===============================================================================
void System_clk_initial(void)
{
    UNLOCKREG();
    SYSCLK->PWRCON.XTL12M_EN = 1;//使用外部12M晶振为时钟源
    ...
    SYSCLK->CLKSEL0.HCLK_S =2;//PLL输出为HCLK时钟源
    LOCKREG();
