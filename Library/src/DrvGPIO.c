...
//	modefy		:null
//===============================================================================
void DrvGPIO_SetBit_new(E_DRVGPIO_PORT port, int32_t i32Bit)
{
	GPIO_T * tGPIO;
	tGPIO = (GPIO_T *)((uint32_t)GPIOA + (port*PORT_OFFSET));  
	tGPIO->DOUT |= (1 << i32Bit);
...
//	modefy		:null
//===============================================================================
void DrvGPIO_ClrBit_new(E_DRVGPIO_PORT port, int32_t i32Bit)
{
	GPIO_T * tGPIO;
	tGPIO = (GPIO_T *)((uint32_t)GPIOA + (port*PORT_OFFSET));  
	tGPIO->DOUT &= ~(1 << i32Bit);    
